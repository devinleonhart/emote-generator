  ...
  <section id="emote-options">
    <div class="field">
      ...
      <div class="select is-medium">
        <select v-model="state.sCharacter" @change="onCharacterChange">
    ...
    <div class="field">
      ...
      <div class="select is-medium">
        <select v-model="state.sBlueprint" @change="onBlueprintChange" :disabled="!selectedCharacter">
          <option value="" selected></option>
          <option v-for="blueprint in blueprints">{{ blueprint }}</option>
        </select>
      </div>
    </div>

    <div class="box" v-if="selectedCharacter">
      <part-picker :part-selection="parts.head || []" :part-name="'head'" />
      <part-picker :part-selection="parts.eyebrows || []" :part-name="'eyebrows'" />
      <part-picker :part-selection="parts.eyes || []" :part-name="'eyes'" />
      <part-picker :part-selection="parts.mouth || []" :part-name="'mouth'" />
    </div>
